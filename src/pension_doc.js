const pensionDocs = {
    ...
    "-xmlns": "p03:bot",
        "InfoMessage": [
        {
            "Name": "Страховая пенсия по старости",
            "Code": "1",
    ...
    {
        "Name": "Страховая пенсия родителям детей-инвалидов",
        "Code": "2",
    ...
    {
        "Name": "Страховая пенсия матерям, имеющим 5 детей и более",
        "Code": "3",
        "Message": "Перечень необходимых документов:"
            +"• паспорт;"
            +"• СНИЛС;"
    ...
    {
        "Name": "Страховая пенсия по СПК вдове, вдовцу",
        "Code": "4",
    ...
    {
        "Name": "Страховая пенсия по СПК на детей",
        "Code": "5",
    ...
    {
        "Name": "Страховая пенсия пенсионерам силовых структур",
        "Code": "6",
    ...
    {
        "Name": "Социальная пенсия по СПК на детей",
        "Code": "7",
        "Message": "Перечень необходимых документов:"
            +"• паспорт ребенка (документ, удостоверяющий личность и полномочия законного представителя (усыновителя,"
        +"опекуна, попечителя);"
